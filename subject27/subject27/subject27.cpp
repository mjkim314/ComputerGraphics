...
int main(void) {
	...
	glGenBuffers(1, &triangleVB1);
	glBindBuffer(GL_ARRAY_BUFFER, triangleVB1);
...
void render(GLFWwindow* window) {
	...
	glUniform3fv(glGetUniformLocation(program, "diffuseColor"), 1, glm::value_ptr(diffuseColor[0]));
	glUniform1f(glGetUniformLocation(program, "shininess"), shininess[0]);
